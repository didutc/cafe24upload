...
for li in trs:
    ...
    try:
        tnumber=tt.split('A간편')[1].split('<')[0]
...
for li in tg:
    ...
    while True:
        try:
            driver.find_element('xpath','/html/body/div/div[2]/div[1]/div/div[1]/table/tbody/tr/th[1]/div')
            break
        except:
            time.sleep(1)
    while True:
    ...
    while True:
        try:
            ...
            driver.find_element('xpath','/html/body/div/div[2]/div[1]/div/div[3]/div/div[1]/div/table/tbody/tr/td[2]/div/div/div/div[1]/table/tbody/tr[1]/td[2]/div/div[1]/ul/li[2]/label').click()
    ...
    while True:
        try:
            ...
            driver.find_element('xpath','/html/body/div/div[2]/div[1]/div/div[3]/div/div[1]/div/table/tbody/tr/td[2]/div/div/div/div[1]/table/tbody/tr[2]/td[2]/div/div[1]/ul/li[2]/label').click()
