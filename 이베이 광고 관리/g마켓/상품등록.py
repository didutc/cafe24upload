...
while True:
    ...
    data = doubleagent.picklereader('gmarketfinal.pkl')
    print(len(data))
    if len(data) == 0:
        break
    ...
    while True:
        try:
            ...
            time.sleep(1)
    driver.find_element_by_xpath('/html/body/div/div[2]/div[1]/div/div[3]/div/div[2]/div/dl/dd/span[1]/input').send_keys('G간편'+str(groupcount))
    ...
    doubleagent.picklemaker('gmarketfinal.pkl',data)
    try:
        da = Alert(driver)
        da.accept()
    except:
