...
item_list = []
for target_page in range(0,int(flag)):
    if target_page > 0:
        driver.find_element_by_xpath('/html/body/div/div[2]/div/div[4]/div[3]/div[4]/a['+str(3+target_page)+']/span').click()
    while True:
    ...
    for i,li in enumerate(group,start=1):
        ...
        while True:
            try:
                ...
                continue
        counter = 0
        driver.find_element_by_xpath('/html/body/div/div[2]/div[1]/div/div[4]/div/button/span').click()
        driver.find_element_by_xpath('/html/body/div/div[2]/div[1]/div/div[4]/div/div/div/div[1]/table/tbody/tr/td/div/p/span[3]/input').send_keys(200)
        driver.find_element_by_xpath('/html/body/div/div[2]/div[1]/div/div[4]/div/div/div/div[2]/button[1]/span').click()
        while True:
            try:
                da = Alert(driver)
                da.accept()
