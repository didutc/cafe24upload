...
for data in item_list:
    ...
    inputy = driver.find_elements_by_xpath('/html/body/ui-view[1]/div[3]/div/div[3]/div/ui-view/div[2]/fieldset/form/ng-include/ui-view[15]/div[2]/div[2]/div/div[1]/div/ncp-product-attribute-table/div[2]/table/tbody[1]/tr[3]/td/div/div/div[1]/label')
    selector = '비타민A,비타민C'
    ...
    driver.find_element_by_xpath('/html/body/ui-view[1]/div[3]/div/div[3]/div/ui-view/div[2]/fieldset/form/ng-include/ui-view[15]/div[2]/div[2]/div/div[1]/div/ncp-product-attribute-table/div[2]/table/tbody[2]/tr[2]/td/div/div/div/div/div[1]').click()
    ...
    driver.find_element_by_xpath('/html/body/ui-view[1]/div[3]/div/div[3]/div/ui-view/div[2]/fieldset/form/ng-include/ui-view[15]/div[2]/div[2]/div/div[1]/div/ncp-product-attribute-table/div[2]/table/tbody[2]/tr[3]/td/div/div/div/div/div[2]/div/div[2]').click()
    ...
    driver.find_element_by_xpath('/html/body/ui-view[1]/div[3]/div/div[3]/div/ui-view/div[2]/fieldset/form/ng-include/ui-view[15]/div[2]/div[2]/div/div[1]/div/ncp-product-attribute-table/div[2]/table/tbody[2]/tr[4]/td/div/div/div/div/div[2]/div/div[2]').click()
    ...
    driver.find_element_by_xpath('/html/body/ui-view[1]/div[3]/div/div[3]/div/ui-view/div[2]/fieldset/form/ng-include/ui-view[15]/div[2]/div[2]/div/div[1]/div/ncp-product-attribute-table/div[2]/table/tbody[2]/tr[5]/td/div/div/div/div/div[2]/div/div[2]').click()
    ...
    driver.find_element_by_xpath('/html/body/ui-view[1]/div[3]/div/div[3]/div/ui-view/div[2]/fieldset/form/ng-include/ui-view[15]/div[2]/div[2]/div/div[1]/div/ncp-product-attribute-table/div[2]/table/tbody[2]/tr[7]/td/div/div/div/div/div[2]/div/div[27]').click()
    ...
    driver.find_element_by_xpath('/html/body/ui-view[1]/div[3]/div/div[3]/div/ui-view/div[2]/fieldset/form/ng-include/ui-view[15]/div[2]/div[2]/div/div[1]/div/ncp-product-attribute-table/div[2]/table/tbody[2]/tr[8]/td/div/div/div/div/div[2]/div/div[3]').click()

    driver.find_element_by_xpath('/html/body/ui-view[1]/div[3]/div/div[3]/div/ui-view/div[2]/fieldset/form/ng-include/ui-view[15]/div[2]/div[2]/div/div[1]/div/ncp-product-attribute-table/div[2]/table/tbody[2]/tr[8]/td/div/div[2]/div[1]/div/input').send_keys(100)
